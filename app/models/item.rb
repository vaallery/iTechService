...
class Item < ActiveRecord::Base
  ...
  delegate :name, :code, :feature_accounting, :prices, :feature_types, :retail_price, :actual_prices, :quantity_in_store, :product_category, :discount_for, :is_service, to: :product, allow_nil: true
