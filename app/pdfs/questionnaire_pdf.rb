...
class QuestionnairePdf < Prawn::Document
  ...
  def initialize view, data
    ...
    # Agreement
    move_down 40
    text 'Настоящим даю свое согласие на обработку Обществом с ограниченной ответственностью «iTech» '+
        '(директор – Колесник Виталий Валерьевич, адрес: Некрасовская, 48А) моих персональных данных и подтверждаю, '+
