...
class QuestionnairePdf < Prawn::Document
  ...
  def initialize view, data
    ...
    # Agreement
    move_down 40
    text 'Настоящим даю свое согласие на обработку Обществом с ограниченной ответственностью «АйТэк» '+
        '(директор – Ю. О. Попов, адрес: Океанский пр-т, 90) моих персональных данных и подтверждаю, '+
        'что, давая такое согласие, я действую своей волей и в своих интересах.', align: :justify
    move_down 12
    text 'Согласие дается мною в целях получения информации о товарах и услугах, пердоставляемых компанией '+
