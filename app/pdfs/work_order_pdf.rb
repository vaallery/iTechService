...
class WorkOrderPdf < Prawn::Document
  ...
  def initialize(service_job, view_context)
    ...
    table [
            ...
            [{content: "Условия проведения диагностики", colspan: 3}],
            ["8.", {content: "Потребитель предупреждён и соглашается с тем, что в связи с техническим состоянием его устройства на момент обращения к продавцу, в процессе ремонта устройство
может потерять частично или полностью основные функции, при этом покупатель соглашается что продавец ответственности за указанный результат не несет.", colspan: 2}],
    ...
    text "Гарантийный ремонт оборудования осуществляется согласно условиям, описанным в гарантийном талоне или заказ-наряде."
    ...
    move_down font_size
    text "С условиями обслуживания и сроками его проведения согласен, правильность заполнения заказа подтверждаю. ИП Колесник В. В. «iTech» оставляет за собой право отказать в проведении гарантийного обслуживания в случае нарушения условий гарантии."
    move_down font_size * 2
