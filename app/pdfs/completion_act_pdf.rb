...
действующим законодательством Российской Федерации. Указание клиентом своего контактного телефона означает его согласие с вышеперечисленными действиями сервисного центра", colspan: 2}],
            ["Аппарат принял: #{service_job&.user&.full_name}", {content: "Работы по Заказ-Наряду выполнены в полном объёме в срок. Недостатки в результате работ не выявлены. Изделие проверено в моём присутствии, претензий по качеству работ и комплектации  изделия нет. Оплату выполненных работ гарантирую.", rowspan: 2}],
            [""],
