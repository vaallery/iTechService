...
Выполнение гарантийного ремонта продлевает срок гарантии на время его выполнения, включая дату приёма и уведомления клиента об окончании ремонта. (Ст.20 п.3 «Закона о защите прав потребителей»)."
    ...
    text "ИП Колесник В. В. «iTech» предпримет все необходимые действия для устранения недостатков выполненной услуги по требованию по требованию потребителя в срок до 60 рабочих дней (Ст.30 «Закон о защите прав потребителей»)."
    move_down font_size

    text "Гарантия на выполненные платные работы не обеспечивает возмещение затрат, связанных с переездами или транспортировкой оборудования до местонахождения ИП Колесник В. В. «iTech»."
    move_down font_size

    text "ИП Колесник В. В. «iTech» не несёт ответственности за любой косвенный ущерб, вызванный проявлением недостатков или дефектов в устройстве, ущерб, причинённый другим устройствам или оборудованию, работающим в сопряжении с данным устройством."
    move_down font_size

    text "ИП Колесник В. В. «iTech» предоставляет гарантию на выполненные платные ремонты в течении 90 дней с момента выдачи аппарата."
...
условии наличия подписи заказчика на данной квитанции.", style: :bold, size: 8
    ...
    text "Работы по Заказ-наряду выполнены в полном объёме в срок. Недостатки в результаты работ не выявлены. Изделие проверено в моём присутствии, претензий по качеству работ и комплектации изделия нет. Оплату выполненных работ гарантирую."
    move_down font_size * 3
