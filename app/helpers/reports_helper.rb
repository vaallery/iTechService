module ReportsHelper
  ...
  def report_names
    %w[device_types device_groups users devices_archived devices_not_archived done_tasks tasks_undone clients tasks_duration device_orders done_orders orders_statuses devices_movements payments salary driver few_remnants_goods few_remnants_spare_parts repair_jobs technicians_jobs technicians_difficult_jobs remnants sales margin quick_orders free_jobs phone_substitutions sms_notifications service_jobs_at_done repair_parts defected_spare_parts]
  end
