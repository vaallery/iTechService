module UsersHelper
  ...
  def profile_link
    ...
    link_to glyph(icon_class) + ' ' + current_user.short_name, profile_path, id: 'profile_link', data: {id: current_user.id, helpable: current_user.helpable?, location: current_user.location_id, role: current_user.role, timeout_in: current_user.timeout_in}
  end
