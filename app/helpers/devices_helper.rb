...
module DevicesHelper
  ...
  def link_to_archive_device(device, options={})
    link_to glyph(:archive)+t('devices.move_to_archive'), device_path(device, device: {location_id: current_user.archive_location.id}), method: :patch, class: 'btn btn-warning', remote: options[:remote]
    # link_to glyph(:archive)+t('devices.move_to_archive'), device_path(device, device: {location_id: Location.archive.id}), method: :patch, class: 'btn btn-warning', remote: options[:remote]
  end
