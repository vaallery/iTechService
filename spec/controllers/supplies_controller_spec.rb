...
describe SuppliesController do
  ...
  let(:valid_attributes) { { "supply_report" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved supply as @supply" do
        ...
        post :create, {:supply => { "supply_report" => "invalid value" }}, valid_session
        assigns(:supply).should be_a_new(Supply)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested supply" do
        ...
        Supply.any_instance.should_receive(:update_attributes).with({ "supply_report" => "" })
        put :update, {:id => supply.to_param, :supply => { "supply_report" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the supply as @supply" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Supply.any_instance.stub(:save).and_return(false)
        put :update, {:id => supply.to_param, :supply => { "supply_report" => "invalid value" }}, valid_session
        assigns(:supply).should eq(supply)
      end
